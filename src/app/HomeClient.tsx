...
export default function HomeClient({ packages, projects }: { packages: Package[], projects: Project[] }) {
  ...
  const displayPackages = packages.filter(p => p.branch === 'studio');
  
  // Filter projects for the studio branch
  const studioProjects = projects.filter(p => p.branch === 'studio');
  ...
  return (
    ...
    >
      {/* Ambient glow */}
      <div className="fixed top-[-30%] left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-[#a78b66]/10 blur-[120px] pointer-events-none -z-[5]" />
      ...
      >
        <div className="w-5 h-8 border-[1.5px] border-[#a78b66] rounded-full flex justify-center pt-1 mb-1 relative">
          <motion.div
            animate={{
              y: [0, 8, 0],
              opacity: [1, 0, 1]
            ...
            className="w-1 h-2 rounded-full bg-[#a78b66]"
          />
        </div>
        <div className="w-[1px] h-6 bg-gradient-to-b from-[#a78b66]/60 to-transparent" />
        <span className="text-[11px] font-bold tracking-widest text-[#a78b66] mt-2">اسحب للأسفل</span>
      </motion.div>
      ...
      <section ref={containerRef} className="relative z-10 w-full" style={{ height: "300vh" }}>
        <div className="sticky top-0 h-[100svh] w-full overflow-hidden flex items-center justify-center">
          ...
          >
            <h2 className="text-xs font-black text-[#a78b66] tracking-[0.3em] uppercase mb-4 w-full">من نحن</h2>
            <h3 className="text-4xl md:text-5xl lg:text-[54px] font-black text-white leading-[1.3] mb-6 lg:whitespace-nowrap white-glow">
              ...
              نحن
              <br className="hidden md:block"/>
              <span className="italic text-[#a78b66]">مهندسو أحلامك الرقمية.</span>
            </h3>
            ...
            <div className="flex gap-10 pt-4 border-t border-[#a78b66]/30">
              <div>
                <h4 className="text-4xl font-black text-white"><CountUp end={200} suffix="+" /></h4>
          ...
          >
            ...
            <p className="text-[10px] sm:text-xs md:text-sm tracking-[0.5em] font-medium text-[#a78b66]/70 mb-6 lg:mb-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white leading-tight mb-4 lg:mb-5 text-center gold-glow-strong">
              ...
              <br />
              <span className="text-[#a78b66]">وهندسة صوتية</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 lg:gap-5">
              <Link
                href="/projects"
                className="flex items-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full bg-[#a78b66] text-[#f5ecd8] font-black text-sm sm:text-base shadow-xl hover:bg-[#3D0A0C] transition-all hover:scale-105 box-gold-glow"
              >
                استكشف أعمالنا
                <ArrowLeft size={18} />
              </Link>
              <button className="flex items-center gap-3 text-[#a78b66] font-bold text-sm sm:text-base hover:opacity-70 transition-opacity">
                <div className="w-10 h-10 rounded-full border-2 border-[#a78b66] flex items-center justify-center">
                  <Play size={14} fill="#a78b66" />
                </div>
                شاهد الفيديو
              </button>
            </div>
            ...
            <div className="mt-14 sm:mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 w-full max-w-4xl">
              {features.map((f, i) => (
                <div key={i} className="flex flex-col items-center gap-2 text-center group">
                  <div className="w-12 h-12 rounded-2xl bg-[#a78b66]/15 border border-[#a78b66]/30 flex items-center justify-center text-[#a78b66] transition-all">
                    {f.icon}
                  </div>
          ...
          >
            <h2 className="text-5xl md:text-7xl lg:text-7xl font-black text-[#a78b66] uppercase drop-shadow-xl gold-glow-strong">
              خدماتنا
            </h2>
      ...
      <motion.div
        ...
        className="fixed right-[5%] lg:right-[8%] top-[25%] w-[88vw] lg:w-[380px] border-[2px] border-dashed border-[#a78b66]/50 bg-black/70 backdrop-blur-lg rounded-lg z-[90] pointer-events-auto box-gold-glow"
      >
        {/* Corner Markers */}
        <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-[#a78b66] -mt-1 -ml-1 rounded-tl" />
        <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-[#a78b66] -mt-1 -mr-1 rounded-tr" />
        <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-[#a78b66] -mb-1 -ml-1 rounded-bl" />
        <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-[#a78b66] -mb-1 -mr-1 rounded-br" />
        ...
        <motion.div style={{ opacity: developOpacity, y: developY }}>
          <div
            ...
            style={{ 
              ...
              backgroundColor: hoveredSection === 'dev' ? 'rgba(167, 139, 102,0.08)' : 'transparent',
              boxShadow: hoveredSection === 'dev' ? '0 10px 30px -10px rgba(167, 139, 102,0.2)' : 'none'
            }}
            className="p-7 rounded-t-lg cursor-default transition-all duration-500"
          >
            <div className="flex items-center gap-3 mb-3">
              <h3 className="text-2xl font-black tracking-wide" style={{ color: hoveredSection === 'dev' ? '#a78b66' : 'white' }}>تصوير وانتاج</h3>
              <div className="p-2 rounded-md transition-all duration-300" style={{ background: hoveredSection === 'dev' ? 'rgba(167, 139, 102,0.3)' : 'rgba(167, 139, 102,0.1)', color: '#a78b66' }}>
            ...
            <p className="text-sm font-bold leading-relaxed border-r-2 pr-3 mb-4 transition-all duration-300" style={{ color: 'rgba(255,255,255,0.7)', borderColor: hoveredSection === 'dev' ? '#a78b66' : 'rgba(167, 139, 102,0.2)' }}>
            ...
            <div className="flex flex-wrap gap-2">
              {["Cinematic", "Photography", "Videography", "Montage", "Editing"].map(tag => (
                <span key={tag} className="px-2.5 py-1 border text-[10px] font-bold rounded-full transition-all duration-300" style={{ background: 'rgba(167, 139, 102,0.08)', borderColor: hoveredSection === 'dev' ? 'rgba(167, 139, 102,0.6)' : 'rgba(167, 139, 102,0.2)', color: '#a78b66' }}>{tag}</span>
              ))}
            </div>
          </div>
        </motion.div>

        <div className="mx-6 border-t-2 border-dashed border-[#a78b66]/25" />
        ...
        <motion.div style={{ opacity: designOpacity, y: designY }}>
          <div
            ...
            style={{ 
              ...
              backgroundColor: hoveredSection === 'des' ? 'rgba(167, 139, 102,0.08)' : 'transparent',
              boxShadow: hoveredSection === 'des' ? '0 -10px 30px -10px rgba(167, 139, 102,0.2)' : 'none'
            }}
            className="p-7 rounded-b-lg cursor-default transition-all duration-500"
          >
            <div className="flex items-center gap-3 mb-3">
              <h3 className="text-2xl font-black tracking-wide" style={{ color: hoveredSection === 'des' ? '#a78b66' : 'white' }}>تحسين أداء الألعاب</h3>
              <div className="p-2 rounded-md transition-all duration-300" style={{ background: hoveredSection === 'des' ? 'rgba(167, 139, 102,0.3)' : 'rgba(167, 139, 102,0.1)', color: '#a78b66' }}>
            ...
            <p className="text-sm font-bold leading-relaxed border-r-2 pr-3 mb-4 transition-all duration-300" style={{ color: 'rgba(255,255,255,0.7)', borderColor: hoveredSection === 'des' ? '#a78b66' : 'rgba(167, 139, 102,0.2)' }}>
            ...
            <div className="flex flex-wrap gap-2">
              {["FPS Boost", "PC Tweaks", "Low Latency", "Ping Fix", "Windows Opt"].map(tag => (
                <span key={tag} className="px-2.5 py-1 border text-[10px] font-bold rounded-full transition-all duration-300" style={{ background: 'rgba(167, 139, 102,0.08)', borderColor: hoveredSection === 'des' ? 'rgba(167, 139, 102,0.6)' : 'rgba(167, 139, 102,0.2)', color: '#a78b66' }}>{tag}</span>
              ))}
            </div>
          </div>
        </motion.div>
      ...
      <section id="reviews" className="relative z-10 py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="relative bg-black/50 backdrop-blur-md border border-[#a78b66]/30 rounded-3xl p-10 shadow-2xl box-gold-glow">
            <Quote size={36} className="text-[#a78b66]/40 mx-auto mb-4" />
            <p className="text-xl text-white/85 font-medium leading-relaxed mb-8">
              "{activeReviews[activeReview]?.content}"
            </p>
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#a78b66]/20 border border-[#a78b66]/30 flex items-center justify-center font-black text-[#a78b66]">
              ...
              <div className="text-right">
                ...
                <div className="flex gap-0.5">
                  {[...Array(activeReviews[activeReview]?.rating || 5)].map((_, i) => (
                    <Star key={i} size={12} fill="#a78b66" className="text-[#a78b66]" />
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-center gap-2 mt-8">
              {activeReviews.map((_, i) => (
                <button
                  ...
                  className={`w-2 h-2 rounded-full transition-all ${i === activeReview ? 'w-6 bg-[#a78b66]' : 'bg-[#a78b66]/30'}`}
                />
              ))}
            </div>
          </div>
      ...
      {/* ─── Footer ─── */}
      <footer className="relative z-10 border-t border-[#a78b66]/20 py-10 px-6 text-center">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-5 text-sm font-bold text-[#a78b66]/60">
            <a href="#" className="hover:text-[#a78b66] transition-colors">واتساب</a>
            <a href="#" className="hover:text-[#a78b66] transition-colors">إنستقرام</a>
            <a href="#" className="hover:text-[#a78b66] transition-colors">𝕏</a>
          </div>
        </div>
      </footer>
    </div>
