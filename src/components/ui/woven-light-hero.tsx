  ...
  useEffect(() => {
    ...
    const animate = () => {
        ...
        for (let i = 0; i < particleCount; i++) {
            ...
            if (dist < 4.0) { // زدت المسافة بشكل كبير
                const force = (4.0 - dist) * 0.06; // زدت قوة التنافر
        ...
        // دوران متواصل + التفات كامل وسلس باتجاه الماوس لزيادة التفاعل!
        const targetRotationX = mouse.y * 1.5;
        const targetRotationY = elapsedTime * 0.1 + mouse.x * 1.5;
        
        points.rotation.x += (targetRotationX - points.rotation.x) * 0.02;
        points.rotation.y += (targetRotationY - points.rotation.y) * 0.02;
