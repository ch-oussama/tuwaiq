        ...
        >
          {projects.map((project, i) => {
            ...
            return (
              ...
              >
                <div className={`relative w-full aspect-square rounded-xl overflow-hidden group cursor-pointer shadow-lg outline outline-1 transition-all ${branch === 'design' ? 'outline-white/10 hover:outline-[#a78b66]' : 'outline-white/10 hover:outline-[#a78b66]'} hover:outline-2`}>
                  ...
                  <div className={`absolute inset-0 transition-colors pointer-events-none flex items-end justify-center pb-4 ${branch === 'design' ? 'bg-white/10 group-hover:bg-white/5 backdrop-blur-[1px]' : 'bg-black/30 group-hover:bg-black/10'}`}>
            ...
            >
              ...
              >
                ...
                <Link href={`/projects/${activeProject.id}`}>
                  <button className={`mt-2 flex items-center gap-3 px-8 py-3.5 rounded-full font-bold transition-all shadow-md hover:scale-105 ${branch === 'studio' ? 'bg-[#a78b66] text-black hover:bg-[#8b7355]' : 'bg-[#a78b66]/80 text-[#2d1a12] hover:bg-[#a78b66] backdrop-blur-sm'}`}>
